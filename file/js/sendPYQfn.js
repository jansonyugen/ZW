	...
	randonElem() {
		...
		<!-- 这里放内容 -->
			<div class="userContain">
				<div class="userHeadImg"><img src="${this.userHeadImg}" style="width:40px;height:40px;border-radius:5px;"></img></div>
				<div class="otherContain">
					...
					<div class="dateAndChoic">
						<span class="date">${this.time}mins ago</span>
						<div class="choic"><span class="point"></span><span class="point"></span></div>
						<div class="commendChoic" style="display: none;">
							<div class="choicList">
								<div class="zan"><img src="img/zan.png"> <span>like</span></div>
								<div class="pinglun"><img src="img/评论.png"> comment</div>
							</div>
						</div>
					</div>
...
var pyq1 = new PYQLIST("黄思杰", "./img/User_img.jpg", "JANSON", "新的一年里，大家一定要快乐啊！", ["./img/123.jpg","./img/333jpg.jpg"], myPYQ, sendDate, pyq1zanList,
	pyq1CommendList);
